...
let BRAND = {
    ...
    site: {
        title: 'Кремлёвка — защищённая линия.',
    ...
    meta: {
        description:
            'Кремлёвка — защищённые видеозвонки, обмен сообщениями и демонстрация экрана в браузере.',
        keywords:
            'webrtc, видеозвонки, демонстрация экрана, связь, браузер, кремлёвка',
    },
    html: {
        features: true,
        teams: true,
    ...
    about: {
        ...
        html: `
            ...
            <br /><br />
            <hr />
            <span>&copy; 2025 Кремлёвка, все права защищены</span>
            <hr />
        `,
    },
    widget: {
