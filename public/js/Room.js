...
function handleSelects() {
    ...
    switchEveryoneCantDrawScreenAnnotations.onchange = (e) => {
        const screenAnnotationsCantDraw = e.currentTarget.checked;
        rc.updateRoomModerator({ type: 'screen_annotations_cant_draw', status: screenAnnotationsCantDraw });
        rc.roomMessage('screen_annotations_cant_draw', screenAnnotationsCantDraw);
        localStorageSettings.moderator_screen_annotations_cant_draw = screenAnnotationsCantDraw;
        lS.setSettings(localStorageSettings);
        e.target.blur();
    };
...
function showAbout() {
    ...
    Swal.fire({
        ...
        title: BRAND.about?.title && BRAND.about.title.trim() !== '' ? BRAND.about.title : 'WebRTC SFU v2.4.91',
